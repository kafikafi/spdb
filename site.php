...
if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])){
  echo "
<h1>Untuk mengakses halaman, Anda harus login dulu.</h1>
<p>
...
<html lang="en">
	...
	<body class="no-skin">
        ...
        if ($_SESSION['level']=='1' OR $_SESSION['level']=='2'){
          ...
          $jum=mysqli_num_rows(mysqli_query($konek,"SELECT * FROM tb_po WHERE supplier_name='$user'"));
          if($jum>0){
            $icon="animated";
          ...
          ?>
                   ...
                   ?>
                    ...
                    Lihat Semua Purchase Order
						...
						<?php
            include "config/koneksi.php";
          $jumX=mysqli_num_rows(mysqli_query($konek,"SELECT * FROM tb_po WHERE supplier_name='$user'"));
          if($jumX>0){
